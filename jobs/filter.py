...
# they're implemented. Anything else is rejected — keeps stray test postings
# or future-source bleed out of results.
ALLOWED_SOURCES = frozenset({"usajobs", "calcareers", "csu", "edjoin"})
